  ...
  return new Promise<Buffer>((resolve, reject) => {
    try {
      ...
      if (reportType === 'category') {
        doc.rect(40, 40, 515, 60).fill('#10b981'); 
        ...
        doc.rect(40, 40, 515, 60).fill('#0ea5e9'); 
        ...
        let rowY = dY + 38;
        const timeline = patterns.timeline.slice().reverse(); 
        ...
        doc.rect(40, 40, 515, 60).fill('#8b5cf6'); 
        ...
        const categoriesList = patterns.byCategory.slice(0, 5); 
