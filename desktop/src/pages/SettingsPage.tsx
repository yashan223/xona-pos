    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6 animate-fade-in text-left">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configure application defaults, cloud synchronization, VAT rates, and localization preferences
        </p>
      </div>
            ...
            <div className="p-4 rounded-xl bg-secondary/20 border border-border/50 space-y-3">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Real-time status of Cloud DB synchronization
                  </p>
                </div>
              ...
              <button
                ...
                disabled={syncing}
                className="w-full mt-2 py-2 rounded-lg bg-primary text-primary-foreground font-bold text-xs hover:bg-primary/95 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
